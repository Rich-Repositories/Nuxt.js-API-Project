<template>
  <div>
    <v-row  class="mr-5 ml-1">
      <v-data-table :headers="headers" :items="items" :items-per-page="50" :search="search" :loading="loading" :dense="dense" sort-by="name" class="elevation-1 w-100" :footer-props="{
    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: 'Arabic Name', value: 'arName', align: 'center', class: 'title mb-5'},
