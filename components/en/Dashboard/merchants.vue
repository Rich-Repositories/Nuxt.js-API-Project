<template>
  <div class="en-dashCategories">
    ...
    <v-row  class="mr-5 ml-1">
      <v-data-table :headers="headers" :items="items" :search="search" :items-per-page="50" :loading="loading" :dense="dense" sort-by="name" class="elevation-1 w-100" :footer-props="{
